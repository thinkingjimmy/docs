...
icon: 'font'
og:image: '/images/basics/flux-prompt/flux-prompt-header-image.png'
twitter:image: '/images/basics/flux-prompt/flux-prompt-header-image.png'
---
...
最后，我再推荐一个辅助写 Prompt 的插件 [Bilbox ComfyUI](https://github.com/syllebra/bilbox-comfyui)。这个插件可以帮你更好地组织你的 prompt。
